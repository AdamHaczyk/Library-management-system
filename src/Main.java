...
public class Main {
    public static void main(String[] args) throws SQLException {
        ...
        //LibraryManagementSystem library1 = new LibraryManagementSystem();     WORK IN PROGRESS
...
class Book {
    ...
    public Book(int book_id, String title, String author, String ISBN) throws SQLException {
        this.book_id = book_id;
        this.title = title;
        this.author = author;
        this.ISBN = ISBN;
